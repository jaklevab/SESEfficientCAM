    ...
    def __init__(self, model, output_index=0, custom_loss=None):
        ...
        with tf.Graph().as_default(): 
            with tf.Session(config=cfg).as_default(): 
                ...
                load_model('/tmp/gbbis_keras.h5', custom_objects={"custom_loss":custom_loss})
...
if __name__ == '__main__':
    ...
    full_im_df_ua = full_im_df_ua[full_im_df_ua.FUA_NAME == "Marseille"]
    #
    ...
    efficientnet_model = load_model(
        MODEL_OUTPUT_DIR + "prev_vers/2019_income_norm/Marseille/" + "lastbest-0.hdf5",custom_objects=dic_load_model)
    #efficientnet_model = load_model(
    #    MODEL_OUTPUT_DIR + "den¡sity/lastbest-0.hdf5",custom_objects=dic_load_model)
    ...
    pickle.dump(test,open(MODEL_OUTPUT_DIR + "prev_vers/2019_income_norm/Marseille/urbanization_patterns_marseille_income.p", "wb"))
