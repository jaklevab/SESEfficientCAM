...
if __name__ == '__main__':
    ...
    efficientnet_model = load_model(
        MODEL_OUTPUT_DIR + "prev_vers/2019_income_norm/Paris/" + "lastbest-0.hdf5",custom_objects=dic_load_model)
    #efficientnet_model = load_model(
    ...
    pickle.dump(test,open(MODEL_OUTPUT_DIR + "prev_vers/2019_income_norm/Paris/urbanization_patterns_paris_income.p", "wb"))
