...
nb_channels = 3
batch_sz = 32
transform = transforms.Compose([transforms.ColorJitter(),transforms.RandomCrop((w_desired,h_desired)),
                                transforms.ToTensor(),])
...
gamma = 0.1
st_size = 2
ckpt_dir = output_dir + "../model_data/resnet_random_classic_multiple_crops/"
...
# Model Testing
print("Testing Model")
test_loader = DataLoader(dg_dataset, batch_size=16, num_workers=4, sampler=test_idx)
