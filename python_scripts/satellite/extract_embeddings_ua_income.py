...
MODEL_OUTPUT_DIR = BASE_DIR + "SATELSES/equirect_proj_test/cnes/data_files/outputs/model_data/resnet50_keras/UA_income/"
...
fully_sampled.to_csv(MODEL_OUTPUT_DIR + "embeddings/full_tsne_emb.csv",index=False)
